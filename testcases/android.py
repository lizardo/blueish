...
def run_haltest():
    ...
    commands = [
        ...
        ("adapter_state_changed_cb: state=BT_STATE_ON",
            "bluetooth get_adapter_properties"),
        ("if_bluetooth->get_adapter_properties: BT_STATUS_SUCCESS",
            "bluetooth start_discovery"),
        ("device_found_cb: num_properties=2",
        ...
        #("if_bluetooth->get_remote_services: BT_STATUS_SUCCESS", "bluetooth get_profile_interface hidhost"),
        ("if_bluetooth->get_remote_device_properties: BT_STATUS_SUCCESS",
            "bluetooth get_profile_interface hidhost"),
        (">", "hidhost init"),
        ("if_hh->init: BT_STATUS_SUCCESS", "hidhost connect 12:34:12:34:12:34"),
        ("connection_state_cb: bd_addr=12:34:12:34:12:34 " +
            "connection_state=BTHH_CONN_STATE_CONNECTED",
            "hidhost set_info 12:34:12:34:12:34"),
        ("if_hh->set_info: BT_STATUS_UNSUPPORTED",
            "hidhost disconnect 12:34:12:34:12:34"),
        ("connection_state_cb: bd_addr=12:34:12:34:12:34 " +
            "connection_state=BTHH_CONN_STATE_DISCONNECTED", "hidhost cleanup"),
        ("acl_state_changed_cb: status=BT_STATUS_SUCCESS " +
            "remote_bd_addr=12:34:12:34:12:34 state=BT_ACL_STATE_DISCONNECTED",
            "bluetooth disable"),
